...
namespace Accurat.WebAPI.Migrations
{
    ...
    [Migration("20260911111107_AddShiftTimelineEntries")]
    partial class AddShiftTimelineEntries
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccuratSystem.Contracts.Models.CashReconciliation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AccuratSystem.Contracts.Models.CompanySettings", b =>
                {
                    ...
                    b.Property<decimal>("DayShiftAdminPercentage")
                        .HasColumnType("numeric");

                    b.Property<int>("DefaultAppointmentDuration")
                        .HasColumnType("integer");

                    b.Property<decimal>("NightShiftWasherPercentage")
                        .HasColumnType("numeric");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DayShiftAdminPercentage = 2.5m,
                            DefaultAppointmentDuration = 60,
                            NightShiftWasherPercentage = 50.0m
                        });
                });

            modelBuilder.Entity("AccuratSystem.Contracts.Models.DiscountRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AccuratSystem.Contracts.Models.OrderStatuses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AccuratSystem.Contracts.Models.Shift", b =>
                {
                    ...
                    b.Property<decimal>("AdminEarningsSnapshot")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("AccuratSystem.Contracts.Models.TenantFeature", b =>
                {
                    ...
                    b.Property<bool>("IsDiscountRulesEnabled")
                        .HasColumnType("boolean");
