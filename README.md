...
### Главное окно на ПК:
![Use case](./img/MainWindow.png)
### Стол управляющего:
![UML диаграмма](./img/ManagerDeskOverlay.png)
### Интервальный отчет:
![UML диаграмма](./img/CustomReportWindow.png)
### Авторизация на смартфоне:
![UML диаграмма](./img/LoginPage.png)
### Главное окно на смартфоне:
![UML диаграмма](./img/OrdersPage.png)
...
* [x] **Модуль управления филиалами сети:** Окно с настройками филиалов(`название, адрес, номер телефона, тип филиала, кол-во боксов для мойки, кол-во боксов для сервиса, рабочий ли филиал`).
